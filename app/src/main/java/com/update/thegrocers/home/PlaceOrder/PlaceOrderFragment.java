package com.update.thegrocers.home.PlaceOrder;
...
import com.update.thegrocers.Adapters.PlaceOrderAdapter;
import com.update.thegrocers.Callbacks.ICurrentFragment;
import com.update.thegrocers.Callbacks.ILoadTimeFromFirebaseListener;
...
import com.update.thegrocers.EventBus.CartClearedInPlaceOrder;
import com.update.thegrocers.EventBus.CounterCartEvent;
import com.update.thegrocers.EventBus.HideFABCart;
...
import com.update.thegrocers.Payment.PaymentGatewayActivity;
                ...
                .subscribe(cartItems ->
                        ...
                        .subscribe(new SingleObserver<Double>() {
                            ...
                            public void onSuccess(Double totalPrice) {
                                ...
                                if (appliedCoupon != null){
                                    order.setCouponModel(appliedCoupon);
...
//                Date resultDate = new Date(estimatedServerTimeMs);
    ...
    private void writeOrderToFirebase(Order order) {
        String ordNo = Common.createOrderNumber();
        Common.orderPlacedViaCod.setOrderNumber(ordNo);
        FirebaseDatabase.getInstance()
                .getReference(Common.ORDERS_REF)
                    ...
                    public void onSuccess(Double aLong) {
                        ...
                        if (aLong < 1000){
                            ...
                            if (appliedCoupon != null){
                                ...
                                discountAmount = (int) ((p*atotal)/100);
